...
export function AnnouncementBar() {
  return (
    ...
    >
      <div className="mx-auto flex max-w-[2000px] items-center justify-between px-4 py-2.5 pl-6 sm:pl-4">
        <span className="flex items-center gap-2">
          <span className="absolute left-0 top-0 bottom-0 w-1 bg-[var(--color-accent-gold)]" />
          Complimentary shipping above <span className="font-sans">{INR.format(4999)}</span> • 7-day returns
        </span>
