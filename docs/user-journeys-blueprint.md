...
- Webhook arrives before client verify. [@provider-live, moved to `docs/user-journeys-provider-live.md`]
- Webhook replay duplicate. [@provider-live, moved to `docs/user-journeys-provider-live.md`]
- Amount mismatch webhook path. [@provider-live, moved to `docs/user-journeys-provider-live.md`]
- Currency mismatch webhook path. [@provider-live, moved to `docs/user-journeys-provider-live.md`]
...
| UJ-088 | 7 | Webhook arrives before client verify. [@provider-live] | N/A user route (server-side webhook -> backend payment handlers) | Payment webhook endpoint(s), backend payment handlers |
| UJ-089 | 7 | Webhook replay duplicate. [@provider-live] | N/A user route (server-side webhook -> backend payment handlers) | GraphQL `verifyRazorpayPayment` mutation |
| UJ-090 | 7 | Amount mismatch webhook path. [@provider-live] | N/A user route (server-side webhook -> backend payment handlers) | Payment webhook endpoint(s), backend payment handlers |
| UJ-091 | 7 | Currency mismatch webhook path. [@provider-live] | N/A user route (server-side webhook -> backend payment handlers) | Payment webhook endpoint(s), backend payment handlers |
