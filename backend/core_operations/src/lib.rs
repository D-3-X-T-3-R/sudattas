...
use proto::proto::core::{
    ...
    SearchProductAttributeMappingRequest, SearchProductAttributeRequest, SearchProductImageRequest,
    SearchProductRequest, SearchProductVariantRequest, SearchReviewRequest,
    SearchShippingMethodRequest, SearchSizeRequest, SearchTransactionRequest,
    SearchUserActivityRequest, SearchUserRequest, SearchUserRoleRequest, SearchWishlistItemRequest,
    ShipmentsResponse, ShippingAddressesResponse, ShippingMethodsResponse, SizesResponse,
    TransactionsResponse, UpdateCartItemRequest, UpdateCategoryRequest, UpdateColorRequest,
    UpdateCouponRequest, UpdateEventLogRequest, UpdateInventoryItemRequest,
    ...
    VerifyRazorpayPaymentRequest, VerifyRazorpayPaymentResponse, WebhookEventsResponse,
