...
pub async fn update_order(
    ...
    let orders = orders::ActiveModel {
        ...
        cancel_window_ends_at: ActiveValue::Set(existing.cancel_window_ends_at),
        earliest_booking_at: ActiveValue::Set(existing.earliest_booking_at),
        pickup_target_at: ActiveValue::Set(existing.pickup_target_at),
        pickup_target_reason: ActiveValue::Set(existing.pickup_target_reason.clone()),
        pickup_target_set_by: ActiveValue::Set(existing.pickup_target_set_by.clone()),
        pickup_target_updated_at: ActiveValue::Set(existing.pickup_target_updated_at),
