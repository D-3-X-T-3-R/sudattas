...
CREATE TABLE `Shipments` (
  ...
  `shiprocket_status_label` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Shiprocket status label (API or mapped)',
  `status` enum('pending','awb_assigned','label_generated','manifest_generated','pickup_scheduled','picked_up','in_transit','out_for_delivery','delivered','rto_initiated','rto_delivered','cancelled','lost','delayed','failed') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
...
INSERT INTO `schema_migrations` VALUES ('2026-04-04_add_shippingaddresses_isdefault.sql','2026-04-03 19:09:30'),('2026-04-05_seed_admin_roles.sql','2026-04-05 00:05:43'),('20260408_shipments_granular_shiprocket_status.sql','2026-04-08 23:46:25');
...
-- Dump completed on 2026-04-09  0:04:58
