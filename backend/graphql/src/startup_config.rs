...
/// Names treated as safe-to-relax (permissive CORS/webhook-secret defaults). Anything
...
/// misconfigured env var fails closed instead of silently disabling CORS allowlist
/// enforcement, webhook secret enforcement, and strict startup validation. Only
/// leaving these vars entirely unset (the local-dev convention in this repo's
/// .env.example) is treated as safe-to-relax.
